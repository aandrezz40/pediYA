        ...
        <section class="container-form">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <article class="cont-inputs">
                    ...
                    <input type="tel" name="numero_telefono" id="numero_telefono" placeholder="Número Telefónico" class="input-info" required autocomplete="tel">
                </article>
                ...
                <article class="cont-inputs">
                    <input type="text" name="direccion" id="direccion" placeholder="Dirección" class="input-info" required autocomplete="street-address">
